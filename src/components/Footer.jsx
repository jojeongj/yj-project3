...
export default function Footer(){
    return <HStack w="full" bg="gray.800" h="300px" py="20" justifyContent="center" alignItems="flex-start">
        <Grid w={{
            md: "3xl",
            lg: "5xl",
            xl: "7xl"
            ...
            <GridItem>
                <Box w="40">
                <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Marvel_Logo.svg/1200px-Marvel_Logo.svg.png" alt="Main logo"/>
                </Box>
            </GridItem>
            {/*두번째 푸터*/}
            <GridItem w="full">
